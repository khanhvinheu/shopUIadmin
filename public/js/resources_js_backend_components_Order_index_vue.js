    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(props) {
        return [_c("div", {
          ...
          })], 1), _vm._v(" "), _c("td", [_vm._v(_vm._s(item.size.title))]), _vm._v(" "), _c("td", [_vm._v(_vm._s(item.color.title))]), _vm._v(" "), _c("td", [_vm._v(_vm._s(_vm._f("toThousandFilter")(item.price)) + " đ")]), _vm._v(" "), _c("td", [_vm._v("x" + _vm._s(item.quantity))]), _vm._v(" "), _c("td", [_vm._v(_vm._s(_vm._f("toThousandFilter")(item.price_total)) + " đ")])]);
        }), _vm._v(" "), _c("tr", [_c("td", {
          attrs: {
            colspan: "6"
          }
